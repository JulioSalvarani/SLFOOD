...
import '/pedidos/cancela_pedido/cancela_pedido_widget.dart';
import '/pedidos/modifica_pedido/modifica_pedido_widget.dart';
import '/index.dart';
import 'dart:async';
                                        ...
                                        children: [
                                          ...
                                          FutureBuilder<ApiCallResponse>(
                                            ...
                                            builder: (context, snapshot) {
                                              ...
                                              final listViewPegaTodosPedidosResponse =
                                                  snapshot.data!;

                                              return Builder(
                                                builder: (context) {
                                                  final pedidos = getJsonField(
                                                    listViewPegaTodosPedidosResponse
                                                        .jsonBody,
                                                    r'''$''',
                                                  ).toList();
                                                                    ...
                                                                    Expanded(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        valueOrDefault<
                                                                          ...
                                                                          PegaTodosPedidosCall
                                                                              .pedido(
                                                                            listViewPegaTodosPedidosResponse.jsonBody,
                                                                          )?.elementAtOrNull(
                                                                              pedidosIndex),
                                                                          '...',
                                                                        ),
                                                                  ...
                                                                  if (responsiveVisibility(
                                                                    ...
                                                                    Expanded(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        valueOrDefault<
                                                                            String>(
                                                                          (PegaTodosPedidosCall.total(
                                                                            listViewPegaTodosPedidosResponse.jsonBody,
                                                                          )?.elementAtOrNull(pedidosIndex))
                                                                              ?.toString(),
                                                                          '...',
                                                                        ),
                                                                        style: FlutterFlowTheme.of(context)
                                                                                    ...
                                                                                    builder: (dialogContext) {
                                                                                      return Dialog(
                                                                                        ...
                                                                                        child: GestureDetector(
                                                                                          ...
                                                                                          child: ModificaPedidoWidget(
                                                                                            pedido: PegaTodosPedidosCall.pedido(
                                                                                              listViewPegaTodosPedidosResponse.jsonBody,
                                                                                            )?.elementAtOrNull(pedidosIndex),
                                                                                            total: (PegaTodosPedidosCall.total(
                                                                                              listViewPegaTodosPedidosResponse.jsonBody,
                                                                                            )?.elementAtOrNull(pedidosIndex))
                                                                                                ?.toString(),
                                                                                            status: PegaTodosPedidosCall.status(
                                                                                              listViewPegaTodosPedidosResponse.jsonBody,
                                                                                            )?.elementAtOrNull(pedidosIndex),
                                                                                            valorEntrega: (PegaTodosPedidosCall.entrega(
                                                                                              listViewPegaTodosPedidosResponse.jsonBody,
                                                                                            )?.elementAtOrNull(pedidosIndex))
                                                                                                ?.toString(),
                                                                                            subtotal: (PegaTodosPedidosCall.subtotal(
                                                                                              listViewPegaTodosPedidosResponse.jsonBody,
                                                                                            )?.elementAtOrNull(pedidosIndex))
                                                                                                ?.toString(),
                                                                                          ),
